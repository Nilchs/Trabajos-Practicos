...
8. Las llamadas recursivas regresan con sus respectivos valores:
    ...
    f(a, 3) compara 3 con 2 y retorna 2 (el mínimo entre ambos).
    f(a, 4) compara 7 con 2 y retorna 2 (el mínimo entre ambos).
    f(a, 5) compara 9 con 2 y retorna 2 (el mínimo entre ambos).
    La llamada inicial f(a, 6) compara 4 con 2 y retorna 2 (el mínimo entre ambos).
