/*Implementar la función eliminar que reciba un arreglo de números enteros, su dimensión lógica y un número
por parámetro y elimine dicho número si existe en el arreglo.*/
